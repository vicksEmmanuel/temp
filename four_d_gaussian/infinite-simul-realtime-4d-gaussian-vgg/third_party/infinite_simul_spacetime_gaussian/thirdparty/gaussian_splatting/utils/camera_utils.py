...
def loadCamv2(args, id, cam_info, resolution_scale):
    ...
    if camerapose is not None:
        ...
        rays_o = None
        rays_d = None
    cam_val =  Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
    ...
    print(f"cam_val.image_name {cam_val.image_name} cam_val.rayo {cam_val.rayo} cam_val.rayd {cam_val.rayd}")    
